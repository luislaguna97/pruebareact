    ...
    <>
      <ul className={`${menuClicked ? 'hidden' : ''} absolute bg-white top-0 right-0 w-[256px] p-[24px] h-full text-[18px] sm:flex sm:items-center sm:w-[438px] sm:place-content-around sm:p-0 sm:h-auto sm:relative sm:text-[16px]`}>
        ...
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-SoftRed sm:text-4' to="pages/login">inicio</a>
        </li>
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-SoftRed' to="login">inicio de sesión</a>
        </li>
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-SoftRed' to="#">contacto</a>
        </li>
        <li className='mb-8 sm:mb-0'>
          <a className='hover:text-SoftRed' to="#">nuestras marcas</a>
        </li>
